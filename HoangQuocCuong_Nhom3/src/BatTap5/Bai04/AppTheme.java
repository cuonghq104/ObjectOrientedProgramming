 ...
 * @author Cuong
 */
public class AppTheme extends javax.swing.JFrame {

    /**
     * Creates new form AppTheme
     */
    public AppTheme() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Date begin to work");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Address", "Phone number", "Date begin to work"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppTheme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
